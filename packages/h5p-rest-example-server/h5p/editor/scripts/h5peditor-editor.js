...
ns.Editor = function (library, defaultParams, replace, iframeLoaded) {
  ...
  var populateIframe = function () {
    ...
    iframe.contentDocument.write(
      ...
      '</head><body>' +
    //   '<script src="/h5p/editor/ckeditor/plugins/ckeditor_wiris/plugin.js"></script>'+ // TAN FIX LIBRARY
      '<script src="https://www.wiris.net/demo/plugins/app/WIRISplugins.js?viewer=image"></script>' + // TAN FIX LIBRARY   
